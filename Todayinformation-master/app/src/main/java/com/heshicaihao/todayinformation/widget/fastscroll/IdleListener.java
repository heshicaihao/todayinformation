...
package com.heshicaihao.todayinformation.widget.fastscroll;

import android.util.Log;
import android.view.View;
import android.widget.AbsListView;

import com.heshicaihao.todayinformation.widget.fastscroll.IdleListDetector.OnListIdleListener;
